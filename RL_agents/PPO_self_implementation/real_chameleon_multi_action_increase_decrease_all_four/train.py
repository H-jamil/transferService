...
if __name__ == "__main__":
    ...
    parser.add_argument('pretrained_model_directory', help=' Pretrained model directory',
                        choices=['/home/cc/transferService/RL_agents/PPO_self_implementation/simulator_design_multi_action_increase_decrease_all_four_final/ppo_transferClass_multi_action_increase_decrease_score_SLA/ppo_best_model/best_model.zip', '/home/cc/transferService/RL_agents/PPO_self_implementation/simulator_design_multi_action_increase_decrease_all_four_final/ppo_transferClass_multi_action_increase_decrease_energy_SLA/ppo_best_model/best_model.zip', '/home/cc/transferService/RL_agents/PPO_self_implementation/simulator_design_multi_action_increase_decrease_all_four_final/ppo_transferClass_multi_action_increase_decrease_throughput_SLA/ppo_best_model/best_model.zip', '/home/cc/transferService/RL_agents/PPO_self_implementation/simulator_design_multi_action_increase_decrease_all_four_final/ppo_transferClass_multi_action_increase_decrease_energyEfficiency_SLA/ppo_best_model/best_model.zip'])
