...
if __name__ == "__main__":
  ...
  while transfer_s != 1000000:
    _,transfer_s=transfer_service.step(1,4)
    _,transfer_s=transfer_service.step(4,4)
    _,transfer_s=transfer_service.step(7,8)
